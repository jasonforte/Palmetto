...
Design of a dorsal vascular scanner.
\hrule 
% Modify the line below to insert your subtitle.
{\Large Based on near infra-red imaging techniques}
\end{center}}
...
\begin{center}
Presented by:\\
Jason Fort\'{e}		% Insert your name here
\end{center}

\vskip 10mm
\begin{center}
Prepared for:\\
A. van der Byl\\ 		% Insert your supervisor's name here.
...
\\J. C. Fort\'{e} 		% Chante this line to your name.
\vskip10mm
